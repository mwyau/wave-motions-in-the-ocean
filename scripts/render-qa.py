...
EPUB structure, and write a single Markdown report under ``build/render-qa``.
"""
...
DEFAULT_OUT = ROOT / "build" / "render-qa"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="QA output directory (default: build/render-qa)",
    )
    parser.add_argument(
        "--pdf-dpi",
        type=int,
