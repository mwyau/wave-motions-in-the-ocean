% Chapter 6; source PDF: references/chapman-rizzoli-1989/ChapmanRizzoli6.pdf.
...
edge-wave and Poincaré-wave solutions. In this chapter, we shall be more systematic
...
% -----------------------------------------------------------------------------
% Source PDF crop; the source channel perspective and sloping-bottom labels are retained.
\sourceart[0.70]{ChapmanRizzoli6.pdf}{4}{155bp 515bp 145bp 125bp}
...
% Source PDF crop; the source bottom-trapped profiles for large and small $Sk$ are retained.
\sourceart[0.52]{ChapmanRizzoli6.pdf}{5}{175bp 155bp 185bp 490bp}
...
% Source PDF crop; the paired original and scaled slope diagrams are retained.
\sourceart[0.76]{ChapmanRizzoli6.pdf}{7}{120bp 520bp 85bp 125bp}
...
% -----------------------------------------------------------------------------
% Source PDF crop; the source continental-shelf cross-section and stippled ocean are retained.
\sourceart[0.62]{ChapmanRizzoli6.pdf}{10}{155bp 560bp 140bp 80bp}
...
% Source PDF crop; the complete matching-condition root chart is retained.
\sourceart[0.82]{ChapmanRizzoli6.pdf}{12}{75bp 485bp 65bp 160bp}
...
\sourceart[0.58]{ChapmanRizzoli6.pdf}{12}{135bp 315bp 120bp 370bp}

Each mode is constrained to be below some maximum frequency where $\partial\sigma/\partial\ell=0$.
This occurs at
\begin{waveequation}
	\left.\ell\right|_{\sigma_{\max}}=-(k^2+b^2)^{1/2}.
\end{waveequation}
At the maximum frequency, the group velocity is zero meaning that energy does not
...
continental shelf waves occur at discrete frequencies whereas Rossby waves form a
continuum. Of course, Rossby waves would be discretized if they were constrained
...
propagate in either direction. They occur outside a continuum of Poincaré waves. The
complete dispersion diagram looks like

% wave-source-mask: pdf=ChapmanRizzoli6.pdf; page=15; rect=0bp 500bp 300bp 545bp; origin=lower-left; reason=remove the overlapping preceding prose while preserving the complete sigma arrow
\sourceart[0.70]{ChapmanRizzoli6.pdf}{15}{105bp 325bp 85bp 265bp}[0/500/300/545]
...
% Source PDF crop; the source three-dimensional coastal geometry and stippled shelf are retained.
\sourceart[0.56]{ChapmanRizzoli6.pdf}{16}{155bp 374bp 125bp 310bp}
...
% Source PDF crop; the source wind-forced shelf geometry and alongshelf arrows are retained.
\sourceart[0.58]{ChapmanRizzoli6.pdf}{22}{155bp 440bp 135bp 240bp}
