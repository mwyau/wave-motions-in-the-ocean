% Chapter 3; source PDF: references/chapman-rizzoli-1989/ChapmanRizzoli3.pdf.
...
% Vector reconstruction of source figure: stationary-phase Kelvin-wake crest reconstruction.
...
% Vector reconstruction of source figure: nondispersive Mach-cone reconstruction.
...
% Source-traced vector redraw of the PE/KE/flux sketch.
For
\begin{align*}
	\eta & =a\cos(kx-\sigma t),
	     & \sigma^2                                                 & =gk\tanh kD, \\
...
\end{align*}
\wavevectorart[0.22]{ch03-p057-energy-sketch}
...
% -----------------------------------------------------------------------------
% The source figure uses a smaller printed scale. Matching it keeps the full
% p.63 derivation on one sheet.
