% The maintained wording is expanded for the PDF and EPUB, but not the HTML
% reader, which is a continuously updated web view.
\NewDocumentCommand{\waveprereleaseedition}{}{Early Release digital edition\\
	August 2026}

\begin{wavepdfonly}
	\input{cover-modern}
	\input{frontmatter-modern-book}
\end{wavepdfonly}
\begin{wavewebonly}
	\thispagestyle{empty}
	\begin{center}
		...
		\vfill
		{\small\sffamily Edited by \textbf{Albert M. W. Yau}\par}
		\vspace{0.08in}
		{\small\sffamily August 2026\par}
		\begin{waveepubonly}
			{\small\sffamily \waveprereleaseedition\par}
		\end{waveepubonly}
	\end{center}
\end{wavewebonly}
\clearpage
...
\begin{itemize}[leftmargin=2.2em,itemsep=0pt,topsep=0.1em,parsep=0pt,partopsep=0pt]
...
I created this digital edition of \textit{Wave Motions in the Ocean: Myrl's View} as a
...
preserved in scanned form on \href{https://oxbow.sr.unh.edu/ChapmanRizzoli/Wave_Motions_in_the_Ocean.html}{James Pringle's website}. This edition reconstructs the 1989
...
The front cover features Katsushika Hokusai's \textit{Under the Wave off Kanagawa
	(The Great Wave)}, ca.~1830--32, and the back cover features Utagawa Hiroshige's
\textit{Naruto Whirlpool, Awa Province}, ca.~1853, both from The Metropolitan Museum
...
% The paged modern edition uses this photograph as a frontispiece and places the
% cover credit on the edition-notice verso. Flowing outputs keep the source photo here
% and expand the cover-credit marker for EPUB.
\ifdefined\WaveModernBookFrontMatter
\else
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.82\linewidth]{images/salmon-hendershott-como-1980.jpg}
		\par\smallskip
