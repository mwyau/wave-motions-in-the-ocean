...
The 1989 PDFs under `../references/chapman-rizzoli-1989/` control the reconstruction. The
...
a substantive change, the source reading remains in the reconstruction.

Statuses used here:

- **`pending-human-approval`** — a substantive source issue or proposed correction. The
  reconstruction follows the source until the human owner explicitly approves
  the deviation.
...
False-positive audit findings that were shown to match the source are omitted rather than kept as
errata history. Figure source info and equation validation belong in `FIGURES.md`.
...
- **Reconstruction:** Restored to the source pending human approval.
...
- **Reconstruction:** Follows the source pending human approval.
...
- **Reconstruction:** Restored to the source pending human approval.
- **Reason/evidence:** The source equality is dimensional shorthand, but changing it alters the source text.
...
- **Reconstruction:** Restored to the source pending human approval.
- **Reason/evidence:** Horace Lamb lived 1849–1934 and the sixth edition of *Hydrodynamics* is 1932, but changing a source citation year is substantive bibliographic editing.
...
- **Reconstruction:** Restored to the typeset source pending human approval.
