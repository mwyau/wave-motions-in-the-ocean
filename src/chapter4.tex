% Chapter 4; source PDF: references/chapman-rizzoli-1989/ChapmanRizzoli4.pdf.
...
% -----------------------------------------------------------------------------
% Source PDF crop; source PDF ChapmanRizzoli4.pdf, physical page 2, trim=185bp 545bp 155bp 75bp.
\sourceart[0.55]{ChapmanRizzoli4.pdf}{2}{185bp 545bp 155bp 75bp}
...
frequency is called the buoyancy, Brunt--Väisälä or Väisälä frequency and is often used
...
\wavevectorart[0.41]{ch04-p069-dispersion-cone}
...
\sourceart[0.46]{ChapmanRizzoli4.pdf}{6}{220bp 60bp 195bp 610bp}
...
\sourceart[0.52]{ChapmanRizzoli4.pdf}{7}{185bp 350bp 170bp 300bp}
...
% -----------------------------------------------------------------------------
\wavevectorart[0.76]{ch04-p072-phase-energy-theta}
...
\wavevectorart[0.72]{ch04-p072-phase-energy-phi}
...
\wavevectorart[0.72]{ch04-p073-rotation-only-limits}
...
\wavevectorart[0.72]{ch04-p074-stratification-only-limits}
...
\wavevectorart[0.72]{ch04-p075-rotation-stratification-limits}
...
\wavevectorart[0.76]{ch04-p076-waveguide-boundary-problem}
...
% -----------------------------------------------------------------------------
% Source PDF crop; the complete two-row sign chart is retained from the source.
\sourceart[0.78]{ChapmanRizzoli4.pdf}{14}{79bp 532bp 75bp 130bp}
...
% Source PDF crop; the complete Case B/B1 intersection panels are retained from the source.
\sourceart[0.82]{ChapmanRizzoli4.pdf}{16}{35bp 345bp 55bp 272bp}
...
% Equation-generated waveguide dispersion branches.
...
% Source PDF crop; the paired w and u vertical profiles are retained from the source.
\sourceart[0.70]{ChapmanRizzoli4.pdf}{18}{115bp 410bp 100bp 215bp}
...
% Equation-generated n=1 particle-motion cells.
...
% -----------------------------------------------------------------------------
% Source PDF crop; the complete evanescent Case A/A1 root panels are retained from the source.
\sourceart[0.77]{ChapmanRizzoli4.pdf}{20}{75bp 515bp 75bp 70bp}
...
% -----------------------------------------------------------------------------
% Source PDF crop; the complete evanescent Case B/B1 root panels are retained from the source.
\sourceart[0.74]{ChapmanRizzoli4.pdf}{21}{95bp 520bp 75bp 65bp}
...
% Source PDF crop; the stippled topographic-generation sketch is retained from the source.
\sourceart[0.82]{ChapmanRizzoli4.pdf}{22}{70bp 525bp 55bp 125bp}
...
% Source PDF crop; both characteristic panels and their phase arrows are retained from the source.
\sourceart[0.78]{ChapmanRizzoli4.pdf}{25}{85bp 420bp 70bp 235bp}
...
% -----------------------------------------------------------------------------
% Source PDF crop; the source characteristic reflection geometry is retained without simplification.
\sourceart[0.80]{ChapmanRizzoli4.pdf}{26}{75bp 540bp 55bp 65bp}
...
% Source PDF crop; the source projection geometry and angle annotations are retained.
\sourceart[0.58]{ChapmanRizzoli4.pdf}{26}{120bp 225bp 45bp 395bp}
...
% -----------------------------------------------------------------------------
% Exact subcritical wavenumber-ratio triangle.
...
% Exact subcritical velocity-reflection construction.
...
\sourceart[0.80]{ChapmanRizzoli4.pdf}{28}{70bp 60bp 55bp 300bp}
...
\sourceart[0.78]{ChapmanRizzoli4.pdf}{29}{85bp 335bp 90bp 238bp}
...
% Source PDF crop; the source turning-level profile and region labels are retained.
\sourceart[0.50]{ChapmanRizzoli4.pdf}{30}{170bp 430bp 180bp 220bp}
...
% Source PDF crop; the profile, evanescent-mode, travelling-mode, and spectrum panels are retained.
\sourceart[0.72]{ChapmanRizzoli4.pdf}{31}{90bp 225bp 90bp 390bp}
