...
The TeX typography uses STIX Two Text and STIX Two Math from the STIX Fonts
Project, redesigned by Tiro Typeworks, with Adobe's Source Sans 3 for structural
sans-serif text. Both font families are distributed under the SIL Open Font License
1.1; their licenses apply to the font software and do not change the license of this
edition.

The cover reproduces Katsushika Hokusai's \textit{Under the Wave off Kanagawa
(The Great Wave)}, ca. 1830--32, from The Metropolitan Museum of Art Open Access
collection. The artwork is Public Domain and the image is provided under CC0; full
cover credit appears below.
...
% cover credit on the edition-notice verso. Flowing outputs retain the historical
% photo here and expand the cover-credit marker for EPUB.
\ifdefined\WaveModernBookFrontMatter
\else
\begin{figure}[H]
  \centering
  \includegraphics[width=0.82\linewidth]{figures/frontmatter/salmon-hendershott-como-1980.jpg}
  \par\smallskip
