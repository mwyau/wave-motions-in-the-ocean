...
\vspace{0.28in}
{\large\itshape Myrl's View\par}
\vspace{0.78in}
{\normalsize presented to\par}
\vspace{0.16in}
{\Large Myrl C. Hendershott\par}
\vspace{0.62in}
{\normalsize from\par}
\vspace{0.16in}
{\large David C. Chapman and Paola Malanotte-Rizzoli\par}
\vfill
{\normalsize August 1989\par}
\vspace{0.25in}
{\small\sffamily Digital edition by Albert M. W. Yau\par}
...
These lecture notes has been preserved on James Pringle's website and has
...
\begin{figure}[htbp]
  ...
  \includegraphics[width=0.82\linewidth]
    {figures/frontmatter/salmon-hendershott-como-1980.jpeg}
  \caption{Rick Salmon (left) and Myrl Hendershott at Villa Carlotta, Lake Como,
  during the International School of Physics ``Enrico Fermi,'' Course LXXX,
  \textit{Topics in Ocean Physics}, July 1980.}
\end{figure}
