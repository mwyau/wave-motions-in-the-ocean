...
\par\medskip
\noindent\textbf{Cover image.} Katsushika Hokusai (Japanese, 1760--1849),
\textit{Under the Wave off Kanagawa (Kanagawa oki nami ura)}, also known as
\textit{The Great Wave}, from the series \textit{Thirty-six Views of Mount Fuji
(Fugaku sanj\=urokkei)}, ca. 1830--32. Woodblock print; ink and color on paper,
...
through The Met Open Access program under CC0.\par
