% ===== merged from chapter02-p018-025.tex; source-page comments retained =====
% Wave Motions in the Ocean: Myrl's view
% Verbatim reconstruction: Chapter 2, printed pages 18--25.
% Source authority: ChapmanRizzoli0_2.pdf, physical pages 28--35.
% Prose, equations, headings, figures, and page breaks are transcribed from source.
% Unambiguous technical/typographic corrections are recorded in ERRATA.md.
...
$\rho^*=\rho^*(p^*,T)$ and the motions are adiabatic so that $DS/Dt=0$ where $S$ is
...
% Vector reconstruction; source PDF ChapmanRizzoli0_2.pdf, physical page 31, trim=105bp 405bp 100bp 125bp.
...
% -----------------------------------------------------------------------------
% Vector reconstruction; source PDF ChapmanRizzoli0_2.pdf, physical page 32, trim=130bp 440bp 105bp 90bp.
...
% -----------------------------------------------------------------------------
\sourceart[0.70]{ChapmanRizzoli0_2.pdf}{33}{100bp 420bp 90bp 95bp}
...
\sourceart[0.46]{ChapmanRizzoli0_2.pdf}{34}{145bp 125bp 170bp 455bp}
...
% ===== merged from chapter02-p026-033.tex; source-page comments retained =====
% Wave Motions in the Ocean: Myrl's view
% Verbatim reconstruction: Chapter 2, printed pages 26--33.
% Source authority: ChapmanRizzoli0_2.pdf, physical pages 36--43.
% Source prose, equations, figures, and page breaks are retained. Straightforward
% language/typographic corrections are recorded in CHAPTER2_AUDIT.md.
...
% -----------------------------------------------------------------------------
\sourceart[0.84]{ChapmanRizzoli0_2.pdf}{36}{80bp 515bp 75bp 55bp}
...
\sourceart[0.82]{ChapmanRizzoli0_2.pdf}{38}{80bp 95bp 75bp 535bp}
...
% -----------------------------------------------------------------------------
\sourceart[0.78]{ChapmanRizzoli0_2.pdf}{42}{90bp 485bp 80bp 90bp}
...
% ===== merged from chapter02-p034-037.tex; source-page comments retained =====
% Wave Motions in the Ocean: Myrl's view
% Verbatim reconstruction: Chapter 2, printed pages 34--37.
% Source authority: ChapmanRizzoli0_2.pdf, physical pages 44--47.
% Source prose, equations, figures, and page breaks are retained. Straightforward
% language corrections are recorded in CHAPTER2_AUDIT.md.
...
\sourceart[0.54]{ChapmanRizzoli0_2.pdf}{44}{170bp 195bp 170bp 397bp}
...
% -----------------------------------------------------------------------------
% Crop only the sound-speed profile artwork.  The earlier, taller crop also
% captured source prose below the figure and duplicated it in the reconstruction.
\sourceart[0.58]{ChapmanRizzoli0_2.pdf}{45}{150bp 480bp 140bp 55bp}
...
\sourceart[0.82]{ChapmanRizzoli0_2.pdf}{46}{80bp 250bp 70bp 465bp}
