% ===== merged from chapter03-p038-049.tex; source-page comments retained =====
% Wave Motions in the Ocean: Myrl's view
% Verbatim reconstruction: Chapter 3, printed pages 38--49.
% Source authority: ChapmanRizzoli3.pdf. Physical pages 1,3,5--14;
% physical pages 2 and 4 are blank separator sheets in the distributed scan.
% Source wording, equations, figures, and page breaks are retained.
...
% -----------------------------------------------------------------------------
\sourceart[0.66]{ChapmanRizzoli3.pdf}{3}{150bp 505bp 125bp 80bp}
...
\sourceart[0.40]{ChapmanRizzoli3.pdf}{7}{225bp 250bp 225bp 475bp}
...
% -----------------------------------------------------------------------------
\sourceart[0.64]{ChapmanRizzoli3.pdf}{9}{165bp 500bp 130bp 85bp}
...
% ===== merged from chapter03-p050-056.tex; source-page comments retained =====
% Wave Motions in the Ocean: Myrl's view
% Verbatim reconstruction: Chapter 3, printed pages 50--56.
% Source authority: ChapmanRizzoli3.pdf, physical pages 15--21.
% Source wording, equations, figures, and page breaks are retained except for
% explicitly documented corrections in CHAPTER3_AUDIT.md.
...
\sourceart[0.66]{ChapmanRizzoli3.pdf}{17}{145bp 445bp 140bp 285bp}

The wavelength $2\pi/k_0$ increases and the amplitude decreases with $x$. A wavestaff
record of $\eta(x,t)$ at fixed $x$ shows

\sourceart[0.62]{ChapmanRizzoli3.pdf}{17}{160bp 250bp 150bp 470bp}
...
Note that as $t\to\infty$, the foregoing says $\eta(x,t\to\infty)=O(t)$. The solution never
...
% -----------------------------------------------------------------------------
\sourceart[0.73]{ChapmanRizzoli3.pdf}{20}{120bp 520bp 95bp 75bp}
...
\sourceart[0.70]{ChapmanRizzoli3.pdf}{21}{125bp 400bp 115bp 135bp}
...
\sourceart[0.69]{ChapmanRizzoli3.pdf}{21}{130bp 170bp 105bp 430bp}
...
% ===== merged from chapter03-p057-063.tex; source-page comments retained =====
% Wave Motions in the Ocean: Myrl's view
% Verbatim reconstruction: Chapter 3, printed pages 57--63.
% Source authority: ChapmanRizzoli3.pdf, physical pages 22--28.
% Source wording, equations, figures, and page breaks are retained except for
% explicitly documented corrections in CHAPTER3_AUDIT.md.
...
the currents vary only slightly over a wave period or wavelength, then the waves may
be adequately described by slowly varying representation.
...
\sourceart[0.80]{ChapmanRizzoli3.pdf}{26}{70bp 80bp 55bp 325bp}
...
\sourceart[0.80]{ChapmanRizzoli3.pdf}{27}{75bp 330bp 55bp 95bp}
...
\sourceart[0.48]{ChapmanRizzoli3.pdf}{28}{145bp 480bp 110bp 65bp}
