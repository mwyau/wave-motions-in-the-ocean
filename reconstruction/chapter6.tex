% ===== merged from chapter06-p149-155.tex; source-page comments retained =====
% Wave Motions in the Ocean: Myrl's view
% Verbatim reconstruction: Chapter 6, printed pages 149--155.
% Source authority: ChapmanRizzoli6.pdf, physical pages 1,3--8.
...
\sourceart[0.46]{ChapmanRizzoli6.pdf}{5}{175bp 145bp 185bp 470bp}
...
\sourceart[0.76]{ChapmanRizzoli6.pdf}{7}{120bp 500bp 85bp 105bp}
...
% ===== merged from chapter06-p156-162.tex; source-page comments retained =====
% Wave Motions in the Ocean: Myrl's view
% Verbatim reconstruction: Chapter 6, printed pages 156--162.
% Source authority: ChapmanRizzoli6.pdf, physical pages 9--13,15--16.
% Source wording is retained except for corrections explicitly logged in ERRATA.md.
% Original diagrams are cropped directly from the committed source PDF.
...
% -----------------------------------------------------------------------------
\sourceart[0.56]{ChapmanRizzoli6.pdf}{10}{155bp 520bp 140bp 80bp}
...
\sourceart[0.82]{ChapmanRizzoli6.pdf}{12}{75bp 450bp 65bp 135bp}
...
Each mode is constrained to be below some maximum frequency where
...
% ===== merged from chapter06-p163-171.tex; source-page comments retained =====
% Wave Motions in the Ocean: Myrl's view
% Verbatim reconstruction: Chapter 6, printed pages 163--171.
% Source authority: ChapmanRizzoli6.pdf, physical pages 17--25.
% Source wording is retained except for corrections explicitly logged in ERRATA.md.
% Original diagrams are cropped directly from the committed source PDF.
...
\sourceart[0.68]{ChapmanRizzoli6.pdf}{21}{105bp 335bp 90bp 300bp}
...
\sourceart[0.54]{ChapmanRizzoli6.pdf}{22}{155bp 420bp 135bp 240bp}
