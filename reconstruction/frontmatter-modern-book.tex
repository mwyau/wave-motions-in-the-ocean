...
\begin{center}
\vspace*{0.62in}
\includegraphics[width=0.68\linewidth]{figures/frontmatter/salmon-hendershott-como-1980.jpeg}
\par\smallskip
...
% historical lecture notes; record authorship, edition provenance, license, and
% cover-art provenance instead.
\thispagestyle{empty}
\vspace*{2.25in}
{\footnotesize
...
\medskip
\noindent Digital edition prepared by Albert M. W. Yau, Stony Brook,
August 2026.\par
\medskip
...
\medskip
\noindent The historical source scan was preserved on James Pringle's website.
