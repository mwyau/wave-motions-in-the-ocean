...
\wavevectorart[0.46]{ch04-p069-nonrotating-transverse}
...
\wavevectorart[0.52]{ch04-p070-rotating-transverse}
...
% -----------------------------------------------------------------------------
% Equation/inequality-generated frequency-regime classification.
...
% Equation-generated Case B dispersion intersections.
...
% Equation-generated n=1 vertical mode structure.
...
% -----------------------------------------------------------------------------
% Equation-generated evanescent Case A/A1 roots.
...
% -----------------------------------------------------------------------------
% Equation-generated evanescent Case B roots.
...
% Equation-constrained topographic internal-wave generation.
...
% Exact characteristic/wavevector geometry.
...
% -----------------------------------------------------------------------------
% Characteristic-constrained reflection geometry.
...
% Exact subcritical along-wall wavenumber projection geometry.
...
$m_i=Rk_i$ and $m_r=-Rk_r$, so this also gives
\[
 m_r=-m_i\left(\frac{1+aR}{1-aR}\right).
\]
The typeset source includes an additional factor $(R+a)/(R-a)$ in the expression for
$m_r$; that factor is inconsistent with the characteristic directions above and is
recorded in \texttt{ERRATA.md}. This gives the new wavenumbers in terms of the old
ones. Because waves of a given frequency $\sigma$ can only go in the two
...
% Sign-constrained schematic turning-level profile.
...
% Generalized Sturm--Liouville eigenvalue spectrum.
