% ===== merged from chapter04-p064-075.tex; source-page comments retained =====
% Wave Motions in the Ocean: Myrl's view
% Verbatim reconstruction: Chapter 4, printed pages 64--75.
% Source authority: ChapmanRizzoli4.pdf, physical pages 1--12.
% Source wording, equations, figures, and page breaks are retained except for
% explicit corrections recorded in CHAPTER4_AUDIT.md.
...
% ===== merged from chapter04-p076-084.tex; source-page comments retained =====
% Wave Motions in the Ocean: Myrl's view
% Verbatim reconstruction: Chapter 4, printed pages 76--84.
% Source authority: ChapmanRizzoli4.pdf, physical pages 13--21.
% Source wording, equations, figures, and page breaks are retained except for
% explicit corrections recorded in CHAPTER4_AUDIT.md.
...
% ===== merged from chapter04-p085-095.tex; source-page comments retained =====
% Wave Motions in the Ocean: Myrl's view
% Verbatim reconstruction: Chapter 4, printed pages 85--95.
% Source authority: ChapmanRizzoli4.pdf, physical pages 22--32.
% Source wording, equations, figures, and page breaks are retained except for
% explicit corrections recorded in CHAPTER4_AUDIT.md.
